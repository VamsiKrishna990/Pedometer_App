package com.example.mycustompedometer;
...
public class StepsTrackerService extends Service {
    ...
    private static final int WALKINGPEAK = 18; private static final int JOGGINGPEAK = 25;
    private static final int RUNNINGPEAK = 32; private static final int RUNNING = 3;
    private static final int JOGGING = 2;   private static final int WALKING = 1;
    ...
    class StepDetectorListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            System.out.println("################ step dected #############");
    ...
    class ProcessDataTask implements Runnable {
        ...
        public void run() {
            ...
            System.out.println("$$$$$$$$$$$$$$$ seg size: "+dataSize);
        ...
        private static final int WALKINGPEAK = 8;
        ...
        public void findHighPeaks() {
            ...
            int dataSize = mRawDataList.size();
            for (int i = 0; i < dataSize; i++) {
                System.out.println("$$$### data mag: "+mRawDataList.get(i).value);
                ...
                if (mHighestPeakList.get(i).isRealPeak) {
                    if (mHighestPeakList.get(i).value > RUNNINGPEAK) {
                        ...
                        if (mHighestPeakList.get(i).value > JOGGINGPEAK) {
                            ...
                            System.out.println("$$$###$$$### added a walking step");
